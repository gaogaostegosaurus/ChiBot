...
const { prefix, discord_token } = require('./discord.json');

// Below copied from Google Sheets API Quickstart
// https://developers.google.com/sheets/api/quickstart/nodejs
// Changes are eslint exceptions and credentials json
...
fs.readFile('sheets.json', (err, content) => {
...
function authorize(credentials, callback) {
  ...
  // eslint-disable-next-line indent
      // eslint-disable-next-line function-paren-newline, indent
